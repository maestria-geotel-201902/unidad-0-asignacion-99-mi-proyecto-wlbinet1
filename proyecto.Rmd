...
#Tomando en cuenta los datos del Censo Nacional de poblacion y vivienda del 2010, poder se puede definir cual es la distribución espacial de las personas que tienene dificultad para caminar o subir escalones. 
...
```{r}
getwd()        # Optención de la ruta de mi directorio de datos
...
```{r}
st_layers('/home/lbine/material-de-apoyo/data/onamet_prec_anual_sf.gpkg')
prec <- read.csv('/home/lbine/material-de-apoyo/data/onamet_prec_anual_sf.csv', check.names = F)
